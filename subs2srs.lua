...
function menu:print_header(osd)
    ...
    osd:item('Bilingual filter: '):text(h.get_bilingual_filter_status()):newline()
...
local main = (function()
    ...
    return function()
        ...
        mp.add_key_binding("Alt+m", "mpvacious-bilingual-filter-toggle", h.toggle_bilingual_filter)
        mp.add_key_binding("Alt+d", "mpvacious-debug-subtitle-filter", h.debug_subtitle_filter)
